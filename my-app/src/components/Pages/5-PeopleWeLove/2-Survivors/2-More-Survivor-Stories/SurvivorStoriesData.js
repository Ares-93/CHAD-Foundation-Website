const survivorStories = [
  ...
  },
  {
    ...
    story: `
    When Mackenzie’s brother returned home from college, January 5, 2012, Mack recounts, ‘in an effort to stay true to his commitment to the team, Jonathan was completing an hour-long rowing workout on an ergometer he brought home from school when he experienced a severe and deadly arrhythmia. Attempts by his brother, Mom, and EMTs failed to revive him. Doctors and pathologists surmise that he died of a probable arrhythmia from an unknown cause.’ Can the light shine through such sadness? Jonno’s 22-year-old brother, Mack, says, yes. Because of the unknown cause of his brother Jonathan’s arrhythmia and the potential for genetic conditions, Mackenzie was screened with an EKG, which detected an anomaly. An Echocardiogram determined an enlarged and mildly dilated right ventricle. Doctors initially believed that Mac suffered from a condition called ARVD, which can cause deadly arrhythmias with vigorous exercise- certainly a threat for a serious runner. A second Echocardiogram revealed an Atrial Septal Defect, which was responsible for the enlargement. As a 7-time marathoner and generally active person, Mac was stunned to learn that he had a nickel-sized hole in his heart without any symptoms. He was a walking time-bomb. Mac credits his brother Jonathan with saving his Life. Mackenzie underwent open-heart surgery on April 19, 2013, and was able to return to running without the fear of a stroke, right ventricular failure, or death caused by the defect. He is a survivor because of cardiac screening.’
